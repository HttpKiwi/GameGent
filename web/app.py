    ...
    try:
        ...
        if 'left' in data and 'right' in data:
            ...
            left_cfg = StickConfig(
                ...
                mouse_x_dpi=left_data.get('mouse_dpi', 50),
                mouse_y_dpi=left_data.get('mouse_ydpi', 50),
            ...
            right_cfg = StickConfig(
                ...
                mouse_x_dpi=right_data.get('mouse_dpi', 50),
                mouse_y_dpi=right_data.get('mouse_ydpi', 50),
            ...
            cfg = StickConfig(
                ...
                mouse_x_dpi=data.get('mouse_dpi', 50),
                mouse_y_dpi=data.get('mouse_ydpi', 50),
